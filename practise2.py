...
#LOL, this worked, but essentially you created all the combinations, and then you're just picking the longest
#all combinations can be generated by pick not pick also, here you did that iteratively without realizing. 
